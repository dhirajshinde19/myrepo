...
public class MovieServiceImpl implements MovieService {
	...
	@Override
	public ApiResponse getMovieDetails(String moviename) {
		// TODO Auto-generated method stub
		Movie movie = movieRepo.findByMovieName(moviename)
				.orElseThrow(()->new ResourceNotFoundException("Movie dtls not found for given movie name!!!!!!!!!"));
		ApiResponse apirespDTO = mapper.map(movie,ApiResponse.class); 
		return apirespDTO;
	}
